...
2. 判断任务属于“理解孩子，支持成长”“理解自己，形成判断”还是“沉淀经验，长成事业”，再识别具体任务。
...
| 把真实素材、观点或草稿写成微信公众号长文，或续写、改稿、终审 | `wechat-article-writer` |
...
- 已有真实素材或草稿，要形成微信公众号长文、继续改稿或做发布前终审：直接走 `wechat-article-writer`。若先用 `junyi-content-distiller` 提炼素材，只把已确认的事实与来源交给文章 Skill；完整成稿前必须具备最小配置和至少一篇授权全文范本，未经明确授权不自动发布。
