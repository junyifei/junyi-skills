...
首次使用前先读取 [references/upstream-requirements.md](references/upstream-requirements.md)。本公开版不包含首次全年规划生成 Skill；使用者没有兼容全年底座时必须返回 `blocked-upstream`，不能用季度问卷替代全年资料采集。
