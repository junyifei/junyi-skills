...
最后核验：2026-09-01（`wechat-article-writer` 1.0.0 已随仓库 v1.8.0 发布；结构、安全、三端隔离发现、三轮真实写作客观门禁与三轮主观 A/B 均通过。作者生产入口已完成 Codex、Claude Code、OpenClaw 新会话回读与真实回退／恢复复跑；冻结旧版继续保留）。
