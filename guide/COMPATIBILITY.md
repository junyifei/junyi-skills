...
最后核验：2026-09-01（`wechat-article-writer` 1.0.0 候选；结构、安全、三端隔离发现和三轮真实写作客观门禁已通过，但作者三轮主观 A/B 未通过，因此未发布、未切换生产入口）。
...
| `wechat-article-writer` 1.0.0 | 主观验收未通过 | 结构、安全、三端隔离发现、无配置、模拟创作者、三轮真实写作客观门禁和回退复跑均通过；作者在第一、第二轮选择当前私人生产版，第三轮选择公开候选版，因此候选未通过三轮主观门禁，不发布、不切换。详见[候选验收记录](WECHAT-ARTICLE-WRITER-VALIDATION.md) |
