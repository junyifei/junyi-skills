...
| `wechat-article-writer` 1.0.0 | 主观门禁部分通过；第一轮仍阻断 | 结构、安全、三端隔离发现、无配置、模拟创作者、三轮真实写作客观门禁和回退复跑均通过；恢复旧版编辑骨架后，第二轮公开候选版胜出，第三轮此前已由候选胜出，但第一轮仍由当前私人生产版胜出。只继续修第一轮；不发布、不切换。详见[候选验收记录](WECHAT-ARTICLE-WRITER-VALIDATION.md) |
