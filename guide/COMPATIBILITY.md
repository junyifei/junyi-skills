...
最后核验：2026-09-01（`wechat-article-writer` 1.0.0 候选；结构、安全、三端隔离发现和三轮真实写作客观门禁已通过，作者主观 A/B 待验收，因此仍未发布、未切换生产入口）。
...
| `wechat-article-writer` 1.0.0 | 待作者主观验收 | 结构、安全、三端隔离发现、无配置、模拟创作者、三轮真实写作客观门禁和回退复跑均通过；三组盲评已生成，未获作者主观通过前仍不发布、不切换。详见[候选验收记录](WECHAT-ARTICLE-WRITER-VALIDATION.md) |
...
| Claude Code | 隔离发现已验证 | 项目级复制安装和独立新会话发现通过；作者生产入口仍保持冻结旧版，等待主观验收 |
