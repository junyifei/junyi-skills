...
把家长随手发来的一句观察，变成「记录 + 发展分析 + 思维模型复盘」三层结构，并自动归档，作为家庭成长顾问 Agent 持续更新的日常材料。

**定位说明：**本 Skill 适合已经决定建立长期成长档案、接受三层复盘与自动归档的家庭。它不是“三分钟优势觉察卡”的轻量体验流程，也不是搭建家庭成长顾问 Agent 时必须首先安装的 Skill。
