...
> 君一的 AI 时代家庭教育 Skills，作者：君一，许可：CC BY 4.0，来源：https://github.com/junyifei/junyi-skills
...
`junyi-collect-child-growth-intake`、`junyi-build-infant-growth-plan`、`junyi-build-preschool-growth-plan` 和 `junyi-build-school-age-growth-plan` 从作者本人长期使用的儿童成长语料库与规划工作流中抽取资料采集、年龄分流、证据整理、分章生成和质量校验机制，并为本项目重新设计和表述后公开。公开版本不包含客户资料、内部系统配置、飞书资源标识、访问凭证、文件路径、交付渠道和未经公开验证的评分规则。
...
外部网页、平台数据、出版物、量表、图示和框架仍归各自权利人所有，不因本仓库采用 CC BY 4.0 而被重新许可。
