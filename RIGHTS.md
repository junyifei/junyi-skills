...
`collect-child-growth-intake`、`build-infant-growth-plan`、`build-preschool-growth-plan` 和 `build-school-age-growth-plan` 从作者本人长期使用的儿童成长语料库与规划工作流中抽取资料采集、年龄分流、证据整理、分章生成和质量校验机制，并为本项目重新设计和表述后公开。公开版本不包含客户资料、内部系统配置、飞书资源标识、访问凭证、文件路径、交付渠道和未经公开验证的评分规则。
...
- `build-school-age-quarterly-growth-plan`
